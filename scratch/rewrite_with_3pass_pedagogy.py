...
def format_case_study(title, story, solution):
    return f"{title}\n\nOlay: {story}\n\nÇözüm: {solution}"

def create_verified_unit_1():
    return {
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Folyoda Unutulan Minibar Harcaması",
                    "Misafir oda hesabını ödeyip anahtarı verir ve otelden ayrılır. 5 dakika sonra Kat Hizmetleri görevlisi odada 2 adet minibar meşrubatının tüketildiğini bildirir.",
                    "Resepsiyon personeli konuk henüz otelden ayrılmamışsa nezaketle durumu anlatıp tahsilatı yapar; ayrılmışsa kart provizyonundan çekim yapıp adisyon fişini faturaya ekler."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Sistemde Boş Görünen Odada Konuk Eşyası",
                    "Saat 11:30'da Kat Hizmetleri raporu gelir. 105 nolu oda resepsiyon sisteminde 'Çıkış Yapmış/Boş' görünmektedir ancak odada eşyalar vardır.",
                    "Resepsiyonist misafiri telefonla arar. Misafirin çıkış saatini karıştırdığı anlaşılınca oda durumu sistemde 'Geç Çıkış (Late Check-out)' olarak düzeltilir ve ek ücret onaylatılır."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Yüksek Sezonda Çifte Rezervasyon (Overbooking)",
                    "Saat 21:00'de rezervasyonlu konuk gelir ancak oteldeki tüm odalar tamamen doludur.",
                    "Ön büro memuru Forecast raporunu inceler. Overbooking nedeniyle konuk derhal aynı kalitedeki yakındaki anlaşmalı otele taksiyle transfer edilir ve ilk gece konaklaması otel tarafından karşılanır."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Kasa Devrinde 150 TL Açık Çıkması",
                    "Vardiya devri sırasında kasada bulunması gereken tutardan 150 TL eksik olduğu görülür.",
                    "Devreden ve devralan memurlar gün içindeki nakit adisyonları ve POS fişlerini inceler. Bir konuğun nakit ödemesinin yanlışlıkla 'Kredi Kartı' girildiği tespit edilerek kayıt düzeltilir."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Oda Fiyatının Sıfır (0 TL) Unutulması",
                    "Gece denetçisi rapor alırken 205 nolu odanın konaklama fiyatının sisteme '0 TL' girildiğini görür.",
                    "Gece denetçisi acente konfirmasyon belgesini inceler, anlaşmalı fiyatın 1.800 TL olduğunu belirleyerek sisteme işler ve gün sonu kapatmasını hatasız gerçekleştirir."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Gece Yarısı POS Cihazı İletişim Hatası",
                    "Restoran POS cihazı gün sonu alınırken internet bağlantısı kopar ve Z Raporu hatası verir.",
                    "Gece resepsiyonisti cihazı manuel Z raporu moduna alır, fiziki slip toplamlarını sistemle manuel eşleştirir ve arızayı Seyir Defterine yazarak muhasebeye iletir."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Emniyet Denetiminde Eksik Kimlik Bildirimi",
                    "Gece polis denetiminde 302 nolu odada 2 kişi kalırken KBS sisteminde sadece 1 kişinin kayıtlı olduğu anlaşılır.",
                    "Otel yönetimi 1774 Sayılı Kanun gereğince idari para cezası alır. Ön büro müdürü, resepsiyonda kimlik alınmadan oda kartı teslim edilmesini kesinlikle yasaklar."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Önemli Yabancı Büyükelçinin Ziyareti",
                    "Otelde konaklayan bir büyükelçi ayrılırken otel hizmetlerinden çok memnun kaldığını söyler.",
                    "Ön büro müdürü kendisinden otelin Şeref Defterine (VIP Guestbook) duygu ve düşüncelerini yazıp imzalamasını rica eder; bu belge otel arşivinde saklanır."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Sistem Arızasında Zihinden Hesaplama",
                    "Elektrik kesintisi nedeniyle bilgisayarlar kapanır. Bankoda bekleyen 6 kişilik grup nakit ödeme yapıp ayrılmak ister.",
                    "Resepsiyonist pratik matematik yöntemiyle kişi başı 350 TL olan tutarı (6 × 350 = 6 × 700 / 2 = 2.100 TL) zihinden hesaplar ve manuel makbuz keserek konukları uğurlar."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: KDV Hesabında Yapılan Yaygın Hata",
                    "Yeni işe başlayan resepsiyonist KDV dahil 1.100 TL'lik tutardan %10 (110 TL) düşerek matrahı 990 TL hesaplar.",
                    "Ön büro muhasebecisi uyarır: KDV dahil tutardan matrah bulunurken doğrudan yüzde düşülmez; tutar 1,10'a bölünür (1.100 / 1,10 = 1.000 TL). Hatalı hesap düzeltilir."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Düşük Sezonda Zararına Oda Satış Riski",
                    "Kışın bir acente otelden oda başı 300 TL fiyat talep eder. Ancak otelin birim değişken oda maliyeti 350 TL'dir.",
                    "Ön büro müdürü talebi reddeder. Çünkü birim değişken maliyetin (350 TL) altındaki satış otel işletmesine doğrudan zarar yazdırır."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Erken Ödeme İskontosu Teklifi",
                    "Acente 150.000 TL'lik rezervasyon tutarını 4 ay önce peşin ödemeyi teklif ederek %10 iskonto ister.",
                    "Ön büro muhasebesi nakit ihtiyacını inceler. %10 iskonto (15.000 TL) düşülerek 135.000 TL peşin tahsil edilir ve nakit akışı sağlanır."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Arızalı Odaların Doluluk Hesabına Etkisi",
                    "150 odalı otelde 10 oda tadilatta (Out of Order - OOO) olup satışa kapalıdır. O gün 112 oda satılmıştır.",
                    "Satışa hazır oda sayısı (150 - 10 = 140) alınır. Gerçek ODO = (112 / 140) × 100 = %80 olarak doğru hesaplanır. Arızalı odalar kapasiteden düşülür."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Yüksek Doluluk Düşük Gelir Yanılsaması",
                    "A oteli %90 dolulukla oda başı 600 TL'ye satar (RevPAR = 540 TL). B oteli %60 dolulukla oda başı 1.200 TL'ye satar (RevPAR = 720 TL).",
                    "Ön Büro Müdürü B otelinin daha başarılı olduğunu görür. Çünkü RevPAR değeri yüksek olan B oteli daha az yıpranma maliyetiyle daha fazla gelir elde etmiştir."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Fatura Düzenleme Süresinin Geçirilmesi",
                    "Ayrılan konuk fatura istemediğini söyler. Resepsiyonist faturayı kesmeden işlemi kapatır.",
                    "VUK Madde 231/5 uyarınca hizmet bitiminden itibaren en geç 7 gün içinde fatura düzenlenmesi zorunludur. Gece denetçisi durumu fark edip konuk adına e-Arşiv fatura keser ve cezayı engeller."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Karşılıksız Çek İle Karşılaşma",
                    "Acenteden alınan 70.000 TL'lik çek vadesinde bankaya ibraz edildiğinde hesapta karşılığı bulunmaz.",
                    "Otel muhasebesi bankadan 'Karşılıksızdır' kaşesi bastırarak çek protestosu çeker ve Türk Ticaret Kanunu hükümleri uyarınca icra takibi ve yasal işlem başlatır."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Yevmiye Kaydında Borç-Alacak Eşitsizliği",
                    "Stajyer muhasebeci yevmiye kaydında borç tarafına 6.000 TL, alacak tarafına 5.500 TL yazar.",
                    "Çift taraflı kayıt ilkesi gereğince yevmiye maddesinde borç ve alacak toplamı daima EŞİT olmalıdır. Hata tespit edilerek 500 TL'lik eksik kayıt düzeltilir."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Dönem Sonu Kesin Mizan Denetimi",
                    "Yıl sonunda Bilanço düzenlenmeden önce kesin mizan çıkartılır ve borç-alacak kalanları incelenir.",
                    "Geçici mizandaki uyumsuzluklar dönem sonu envanter kaydıyla kapatılır; borç ve alacak toplamları eşitleştikten sonra Kesin Mizan onaylanarak Bilanço çıkarılır."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Kasa Hesabının Alacak Bakiye Vermesi İmkânsızlığı",
                    "Dönem içi mizanda 100 Kasa Hesabının eksi (-) alacak bakiyesi verdiği görülür.",
                    "Muhasebe ilkesi gereği kasede var olan paradan daha fazla para çıkamaz (Kasa hesabı alacak bakiye veremez). Yapılan hatanın bir nakit tahsilatın kayda girilmemesinden kaynaklandığı bulunarak borç kaydı tamamlanır."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Hurdaya Çıkarılan Resepsiyon Bilgisayarı",
                    "Ekonomik ömrünü tamamlayan 10.000 TL'lik eski bilgisayar demirbaş kaydından çıkarılacaktır.",
                    "Birikmiş amortismanı (10.000 TL) borçlandırılarak 257 hesabı kapatılır, 255 Demirbaşlar hesabı alacaklandırılarak muhasebe kaydı sıfırlanır."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Konaklama Gerçekleştiğinde Avans Hesabının Kapatılması",
                    "Yazın otele gelen acente grubu konaklamasını tamamlar ve 60.000 TL'lik fatura kesilir.",
                    "Daha önce alacaklandırılan 340 Alınan Sipariş Avansları Hesabı 60.000 TL BORÇLANDIRILARAK kapatılır, 600 Yurt İçi Satışlar Hesabı ALACAKLANDIRILARAK gelir kaydedilir."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Sermaye Artırımı Kararı",
                    "Otel yönetimi yeni restoran yapımı için sermayeyi 1.500.000 TL artırma kararı alır.",
                    "Ortakların yatırdığı tutar 102 Bankalar hesabına borç kaydedilerken, 500 Sermaye Hesabı 1.500.000 TL alacaklandırılarak Öz Kaynak yapısı güçlendirilir."
                ),
        ...
        "cards": [
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Net Satış Hasılatının Bulunması",
                    "Otelin 600 Yurt İçi Satışları 600.000 TL, 610 Satıştan İadeleri 15.000 TL, 611 Satış İskontoları 25.000 TL'dir.",
                    "Brüt Satışlar (600.000) - İndirimler (15.000 + 25.000) = 560.000 TL Net Satış Hasılatı doğru şekilde hesaplanır."
                ),
            ...
            },
            {
                ...
                "caseStudy": format_case_study(
                    "Örnek Olay: Yıl Sonu Gelir Tablosu Kapanış Kaydı",
                    "31 Aralık gecesi saat 24:00'te tüm gelir ve gider hesapları sıfırlanarak yeni yıla temiz başlanacaktır.",
                    "Tüm 6XX Gelir ve Gider hesapları 690 Kâr/Zarar hesabına devredilerek kapatılır. Gelir Tablosu hesapları yeni yılın başında 0 bakiye ile tertemiz başlar."
                ),
...
units = [
    create_verified_unit_1(),
    create_verified_unit_2(),
    create_verified_unit_3(),
    create_verified_unit_4(),
    create_verified_unit_5(),
    create_verified_unit_6(),
    create_verified_unit_7(),
    create_verified_unit_8(),
    create_verified_unit_9(),
    create_verified_unit_10(),
    create_verified_unit_11(),
]
...
print("Updated 11_on_buro_hizmetleri_notes.dart with string caseStudy and tip.")

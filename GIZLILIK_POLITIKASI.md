# TURİZM DEFTERİM - GİZLİLİK POLİTİKASI (PRIVACY POLICY)

**Son Güncelleme Tarihi:** 18 Temmuz 2026  
**Uygulama Adı:** Turizm Defterim  
**Geliştirici:** Erol Mert YURDAKUL (Eğitimci & Yazılımcı)  
**İletişim:** erolmertyurdakul.turizm@gmail.com  
...
### 2. KVKK VE ÇOCUKLARIN GİZLİLİĞİ (KVKK & COPPA UYUMU)
Uygulamayı 18 yaş altı öğrenciler ve çocuklar yoğun olarak kullandığı için 6698 sayılı **Kişisel Verilerin Korunması Kanunu (KVKK)** ve uluslararası **Çocukların Çevrim İçi Gizliliğini Koruma (COPPA)** standartlarına %100 uyum sağlanmıştır.
...
### 4. SES VE PODCAST İÇERİKLERİ (SPOTIFY / ANCHOR CDN)
* Uygulamada sunulan sesli ders notları ve podcast anlatımları Spotify / Anchor CDN sunucuları üzerinden doğrudan ses akışı (streaming) olarak çalışır.
* Dinleme sayılarına ilişkin sayaçlar tamamen Spotify / Anchor altyapısının sağladığı standart ve anonim sunucu istatistiklerinden ibarettir.
* Uygulamamız bünyesinde öğrencileri veya diğer kullanıcıları takip eden hiçbir çerez (cookie), izleyici (tracker) veya analitik araç **KULLANILMAMAKTADIR**.

---

### 5. PARASAL İŞLEMLER VE REKLAMLAR
* **Reklam Bulunmaz:** Uygulamamızda hiçbir ticari veya 3. taraf reklam ağı **yer almaz**.
* **Tamamen Ücretsizdir:** Uygulama içi satın alma (IAP), abonelik, ücretli içerik veya bağış talebi **bulunmamaktadır**.

---

### 6. GÜNCELLEMELER VE İLETİŞİM

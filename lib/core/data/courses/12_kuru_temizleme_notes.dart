const Map<String, dynamic> kuruTemizlemeUnit1 = {
  "title": "İş Organizasyonu",
  "learningUnit": "1. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580520/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2Fb2b97c60-0f2a-f264-74c3-857cb9117a1a.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "HAZIRLIK VE İSG",
      "title": "KİŞİSEL HAZIRLIK VE İŞ SAĞLIĞI GÜVENLİĞİ",
      "microSummary": "Kuru temizleme işlemi, kullanılan uçucu kimyasalların insan sağlığına zararlı etkilerinden dolayı diğer temizlik işlemlerine göre çok daha fazla güvenlik önlemi ve KKD (Kişisel Koruyucu Donanım) gerektirir.",
      "definitions": [
        {
      ...
      "extraDetails": [
        {
          "title": "Kuru Temizlemenin Tanımı",
          "content": "Kumaşların su kullanılmadan, özel kimyasal çözücüler (solventler) yardımıyla temizlenmesi işlemidir. Su kullanılmaması sayesinde kumaşların dokusu, biçimi ve rengi korunur."
        },
        {
          "title": "Kuru Temizleme Atölyelerinin Tehlike Sınıfı",
          "content": "İş Sağlığı ve Güvenliği Kanunu'na göre kuru temizleme işletmeleri 'Çok Tehlikeli' iş yeri sınıfında yer alır. Ortam sıcaklığı +5 ila +40 °C arasında olmalı ve ortam sürekli havalandırılmalıdır."
        }
      ],
      "tip": "Kuru temizleme atölyesinde maske takmak bir tercih değil, 'Çok Tehlikeli' sınıftaki bir iş yeri için yasal ve hayati bir zorunluluktur."
    },
    {
      "id": 2,
      "tag": "EKİPMANLAR",
      "title": "İŞ İÇİN GEREKLİ ARAÇ GEREÇ VE EKİPMANLAR",
      "microSummary": "Kuru temizleme operasyonunun sorunsuz yürümesi; formların, makinelerin, ütülerin ve temizlik kimyasallarının doğru tanınmasıyla mümkündür.",
      "definitions": [
        {
...
const Map<String, dynamic> kuruTemizlemeUnit2 = {
  "title": "Kuru Temizleme Öncesi Hazırlık İşlemleri",
  "learningUnit": "2. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580551/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2F1c98ddee-9f96-84f4-5122-76b3172bde5d.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "TESLİM ALMA",
      "title": "TEKSTİL ÜRÜNLERİNİ TESLİM ALMA",
      "microSummary": "Konuklardan veya departmanlardan gelen tekstil ürünlerinin özelliklerini inceleyip kayıt altına almak, sürecin ilk ve en kritik adımıdır.",
      "definitions": [
        {
    ...
    },
    {
      "id": 2,
      "tag": "GRUPLANDIRMA",
      "title": "YIKAMA ÖNCESİ GRUPLANDIRMA (TASNİF)",
      "microSummary": "Her tekstil ürünü aynı solventle veya aynı sürede yıkanmaz. Zarar görmelerini engellemek için giysiler yıkama öncesi 4 temel kritere göre gruplandırılır.",
      "definitions": [
        {
          "name": "Rengine Göre",
    ...
    },
    {
      "id": 3,
      "tag": "LEKE ÇIKARMA",
      "title": "ÖN LEKE ÇIKARMA İŞLEMİ",
      "microSummary": "İnatçı lekelerin makineye atılmadan önce leke masasında özel çözücülerle lokal olarak çıkarılması veya yumuşatılması işlemidir.",
      "definitions": [
        {
          "name": "Ön Müdahale",
...
const Map<String, dynamic> kuruTemizlemeUnit3 = {
  "title": "Kuru Temizleme İşlemleri",
  "learningUnit": "3. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580572/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2F27e79aa5-955b-05ec-e34a-6da7c24b78f4.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "MAKİNE İŞLEMİ",
      "title": "KURU TEMİZLEME MAKİNESİNDE İŞLEM VE HAVALANDIRMA",
      "microSummary": "Giysiler solventle temizlendikten sonra üzerinde kalan kimyasal artıkların uçması için mutlaka havalandırılmalıdır.",
      "definitions": [
        {
      ...
      "tip": "Kuru temizlemeden gelen kıyafet yoğun şekilde ilaç (kimyasal) kokuyorsa, işletme 'Havalandırma' işlemini yeterince yapmamış demektir."
    },
    {
      "id": 2,
      "tag": "ÜTÜLEME",
      ...
      "caseStudy": "Lekesi tam çıkmamış bir pantolonu ütülediğinizde, ütünün yüksek sıcaklığı o lekeyi kumaşın liflerine mühürler. Artık o lekeyi hiçbir kimyasal çıkaramaz. Bu yüzden ütü öncesi son kontrol hayati önem taşır."
    }
  ]
};

const Map<String, dynamic> kuruTemizlemeUnit4 = {
  "title": "Günlük/Periyodik Kontrol ve Bakımların Takibi",
  "learningUnit": "4. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580590/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2F678e737a-f999-10d0-adc8-189c19bfcce4.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "PERİYODİK BAKIM",
      "title": "MAKİNE BAKIMLARI: DİSTİLASYON VE FİLTRELER",
      "microSummary": "Yüzbinlerce lira değerindeki kuru temizleme makinelerinin performansını koruması için filtrelerinin günlük ve periyodik olarak temizlenmesi zorunludur.",
      "definitions": [
        {
      ...
      "extraDetails": [
        {
          "title": "Distilasyon (Damıtma) Nedir?",
          "content": "Kuru temizlemede kullanılan solventin, her yıkamadan sonra arıtılarak (buharlaştırılıp tekrar sıvılaştırılması) içindeki kirlerden ayrılması ve bir sonraki yıkama için tekrar tertemiz hâle getirilmesi işlemidir. Kirler 'çamur tankı'nda toplanır."
        }
      ],
      "tip": "Distilasyon işlemi olmasaydı her yıkamada litrelerce pahalı kimyasalı çöpe atmak zorunda kalırdık. Damıtma sistemi, sektörü ekonomik olarak ayakta tutan sistemdir."
    }
  ]
};

const Map<String, dynamic> kuruTemizlemeUnit5 = {
  "title": "Kuru Temizleme Gerektirmeyen Tekstil Ürünleri İçin Yıkama İşlemi",
  "learningUnit": "5. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580626/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2F68a127ef-6fc1-831d-d172-ccc2a45bc015.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "TEKSTİL TÜRLERİ",
      "title": "ÇAMAŞIRHANE TEKSTİLLERİ VE ELYAFLAR",
      "microSummary": "Otellerdeki havlu, çarşaf gibi ürünler kuru temizleme makinesi yerine sanayi tipi dev çamaşır makinelerinde su ve deterjanla yıkanır.",
      "definitions": [
        {
    ...
    },
    {
      "id": 2,
      "tag": "YIKAMA SÜRECİ",
      "title": "YIKAMA, AĞARTMA, KOLALAMA VE HİJYEN",
      "microSummary": "Yıkamada başarının sırrı; kumaşın cinsine uygun su sıcaklığı, doğru kimyasal ve ütü işlemini kolaylaştıran son dokunuşlardır.",
      "definitions": [
        {
...
const List<Map<String, dynamic>> kuruTemizlemeNotes = [
  kuruTemizlemeUnit1,
  kuruTemizlemeUnit2,
  kuruTemizlemeUnit3,
  kuruTemizlemeUnit4,

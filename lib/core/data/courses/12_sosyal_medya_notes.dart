const Map<String, dynamic> sosyalMedyaUnit1 = {
  "title": "E-Ticaret",
  "learningUnit": "1. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580664/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2F5d4d87da-52aa-3934-1022-d5f2ff822309.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "KAVRAM",
      "title": "E-TİCARET KAVRAMI VE MODELLERİ",
      "microSummary": "Ürünlerin ve hizmetlerin internet üzerinden alınıp satılması sürecini ve bu ticaretin farklı taraflarını inceleyen iş modelleridir.",
      "definitions": [
        {
      ...
      "tip": "E-ticaret modelleri kimin kime satış yaptığına göre isimlendirilir. B = Business (Şirket), C = Consumer (Tüketici)."
    },
    {
      "id": 2,
      "tag": "ALTYAPI",
      "title": "E-TİCARET ALTYAPILARI VE GÜVENLİK RİTÜELLERİ",
      "microSummary": "İnternette güvenli alışveriş yapmak ve ödeme almak için güçlü bir yazılımsal altyapı ve şifreleme sistemleri gereklidir.",
      "definitions": [
        {
      ...
      "tip": "SSL sertifikası olmayan sitelerden alışveriş yapmak, kredi kartı bilgilerinizin çalınmasına yol açabilir; kilit simgesini mutlaka kontrol edin."
    },
    {
      "id": 3,
      "tag": "PAZARLAMA",
...
const Map<String, dynamic> sosyalMedyaUnit2 = {
  "title": "Sosyal Medya",
  "learningUnit": "2. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580712/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2F93253023-8a00-4263-a482-04615ea9d0db.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "PLATFORM",
      "title": "SOSYAL MEDYA PLATFORMLARI VE ÖZELLİKLERİ",
      "microSummary": "Kullanıcıların içerik ürettiği ve etkileşime girdiği dijital ağlar, iş dünyasında farklı amaçlarla kullanılır.",
      "definitions": [
        {
          "name": "Sosyal Medya",
      ...
      "tip": "Her sosyal medya platformunun kullanıcı kitlesi ve dili farklıdır; gençler TikTok/Instagram kullanırken, iş dünyası LinkedIn'de buluşur."
    },
    {
      "id": 2,
      "tag": "İÇERİK",
      "title": "İÇERİK PAZARLAMASI VE ETKİLEŞİM YÖNETİMİ",
      "microSummary": "Sosyal medyada başarılı olmak, düzenli içerik planlaması ve takipçilerle güçlü bir iletişim kurmaktan geçer.",
      "definitions": [
        {
      ...
      "tip": "Sadece paylaşım yapmak yetmez; takipçilerin yorumlarına ilk 1 saat içinde yanıt vermek algoritmanın sizi öne çıkarmasını sağlar."
    },
    {
      "id": 3,
      "tag": "REKLAM",
      "title": "SOSYAL MEDYA REKLAMCILIĞI VE ETKİLEYİCİLER",
      ...
      "tip": "Sponsorlu reklamlarda bütçeyi doğru hedefleme yapmak kurtarır; herkese gösterilen reklam para kaybettirir, ilgili kişiye gösterilen kazandırır."
    },
    {
      "id": 4,
      "tag": "KRİZ",
      "title": "TOPLULUK YÖNETİMİ VE SOSYAL MEDYA KRİZLERİ",
      "microSummary": "Gelen yorumları yönetmek ve marka hakkında yayılan olumsuz durumlarda kriz iletişim planını devreye sokmak gerekir.",
      "definitions": [
        {
...
const Map<String, dynamic> sosyalMedyaUnit3 = {
  "title": "Veri Analizi ve Grafikler",
  "learningUnit": "3. Öğrenme Birimi",
  "podcastUrl": "https://anchor.fm/s/114a64400/podcast/play/122580751/https%3A%2F%2Fd3ctxlq1ktw2nl.cloudfront.net%2Fstaging%2F2026-6-8%2Feed14c61-fcfc-9960-8681-ead4474ad341.mp3",
  "cards": [
    {
      "id": 1,
      "tag": "METRİKLER",
      "title": "DİJİTAL ANALİTİK VE ERİŞİM METRİKLERİ",
      "microSummary": "Sosyal medya ve web analizinde kullanılan veriler, yaptığımız çalışmaların başarısını sayılarla ölçmemizi sağlar.",
      "definitions": [
        {
        ...
        {
          "name": "Erişim (Reach) ve Gösterim (Impression)",
          "desc": "Erişim, paylaşımımızı gören benzersiz (tekil) kişi sayısıdır. Gösterim ise paylaşımımızın ekranda toplamda kaç kez görüntülendiğini gösteren sayıdır (bir kişi 3 kez görebilir).",
          "examples": [
            "Örnekle Pekiştirelim: Hazırladığımız reklamı 100 farklı kişi görmüşse Erişim 100'dür. Bu kişiler reklamı toplamda 300 kez ekranlarında kaydırıp görmüşse Gösterim 300'dür."
          ]
        },
        {
          "name": "CTR (Tıklama Oranı / Click-Through Rate)",
          "desc": "Bir reklamı gören kişilerden kaçının o reklama tıklayarak sitemize geldiğini gösteren, reklam kalitesini ölçen yüzde cinsinden başarı oranıdır.",
          "examples": [
            "Örnekle Pekiştirelim: Reklamımız Google'da 1.000 kez gösterildiğinde 50 kişi reklama tıklamışsa, Tıklama Oranımız (CTR) %5 olarak hesaplanır ve bu sektör standartlarında iyi bir başarıdır."
          ]
        }
      ],
      "tip": "Gösterim sayısı her zaman erişim sayısından fazla veya eşittir. Çünkü bir kullanıcı bir içeriği birden fazla kez görebilir."
    },
    {
      "id": 2,
      "tag": "ANALYTICS",
      "title": "DÖNÜŞÜM VE GOOGLE ANALYTICS ANALİZLERİ",
      "microSummary": "Web sitesine gelen ziyaretçilerin kalitesini ve sitedeki hareketlerini analiz eden sistemlerdir.",
      "definitions": [
        {
          "name": "Dönüşüm Oranı (Conversion Rate)",
          "desc": "Web sitemize giren toplam ziyaretçilerden kaçının rezervasyon yapma, sipariş verme veya iletişim formu doldurma gibi ana hedeflerimizi gerçekleştirdiğini gösteren başarı oranıdır.",
          "examples": [
            "Örnekle Pekiştirelim: Otelimizin web sitesini o gün 1.000 kişi ziyaret etmiş ve bu ziyaretçilerden 10 tanesi oda rezervasyonu satın almışsa, Dönüşüm Oranımız %1'dir."
          ]
        },
        {
      ...
      "tip": "Hemen Çıkma Oranının (Bounce Rate) yüksek olması sitenizin yavaş, sıkıcı veya yanlış kitleye reklam verdiğinin en net kanıtıdır."
    },
    {
      "id": 3,
      "tag": "GRAFİKLER",
      "title": "GRAFİK ÇEŞİTLERİ VE VERİ GÖRSELLEŞTİRME",
      "microSummary": "Raporlarda yer alan yüzlerce karmaşık sayının, herkesin kolayca anlayacağı şık grafiklere dönüştürülmesi işlemidir.",
      "definitions": [
        {
          "name": "Veri Görselleştirme",
          "desc": "Karmaşık veri yığınlarını, trendleri ve istatistikleri; tablolar, grafikler ve infografikler yardımıyla görselleştirerek anlaşılır kılma sürecidir.",
          "examples": [
            "Örnekle Pekiştirelim: 10 sayfalık excel tablosundaki karmaşık sayıları, renkli tek sayfalık bir infografik haline getirerek otel yönetim kurulu sunumunda göstermektir."
          ]
        },
        {
          "name": "Sütun Grafiği (Bar Chart)",
          "desc": "Farklı kategoriler arasındaki satış miktarları, ziyaret sayıları gibi büyüklük karşılaştırmalarını dikey veya yatay renkli sütunlarla gösteren grafik çeşididir.",
          "examples": [
            "Örnekle Pekiştirelim: Otelimizin Ocak, Şubat ve Mart aylarında kazandığı toplam gelirleri dikey renkli sütunlarla yan yana koyarak en yüksek ayı tek bakışta görmemizdir."
          ]
        },
        {
          "name": "Çizgi Grafiği (Line Chart)",
          "desc": "Zaman içerisindeki sürekli değişimleri, satış artış veya azalış trendlerini göstermek için kullanılan, noktaların çizgilerle birleştiği grafik türüdür.",
          "examples": [
            "Örnekle Pekiştirelim: Son 12 ayda web sitemizi ziyaret eden kişi sayısının aydan aya nasıl yükseldiğini veya düştüğünü gösteren dalgalı çizgi grafiğidir."
          ]
        },
        {
      ...
      "tip": "Trend analizi ve zamana bağlı değişimler için Çizgi Grafiği; kategoriler arası karşılaştırma için Sütun Grafiği; pay analizi için Daire Grafiği seçilmelidir."
    },
    {
      "id": 4,
      "tag": "OPTIMİZASYON",
      "title": "A/B TESTLERİ VE DİJİTAL OPTİMİZASYON",
      "microSummary": "Reklamlarımızın ve web sitelerimizin kalitesini sürekli test ederek en yüksek verimi elde etme çalışmalarını kapsar.",
      "definitions": [
        {
          "name": "A/B Testi",
          "desc": "Bir reklamın veya web sayfasının iki farklı sürümünü (A versiyonu ve B versiyonu) aynı anda farklı kullanıcılara göstererek hangisinin daha yüksek tıklama veya satış getirdiğini ölçme yöntemidir.",
          "examples": [
            "Örnekle Pekiştirelim: Rezervasyon butonunun rengini A sürümünde kırmızı, B sürümünde yeşil yaparak test etmek ve yeşil butonlu sayfanın %25 daha fazla rezervasyon aldığını görerek yeşil renkte karar kılmaktır."
          ]
        },
        {
          "name": "Meta Pixel (Piksel Kodları)",
          "desc": "Sosyal medya reklam mecralarının (Meta/Facebook) web sitenize eklediği; siteye gelen reklam ziyaretçilerinin sepete ürün atıp atmadığını veya satın alım yapıp yapmadığını takip eden akıllı takip kodlarıdır.",
          "examples": [
            "Örnekle Pekiştirelim: Web sitemize eklediğimiz piksel kodu sayesinde, sitemizde otel odası arayıp rezervasyon yapmadan çıkan kişilere Instagram'da gezinirken tekrar otel reklamımızın gösterilmesidir (Yeniden Pazarlama)."
          ]
        }
      ],
      "tip": "A/B testlerinde her seferinde sadece tek bir değişken (Örn: Sadece görsel veya sadece başlık) değiştirilmelidir; aksi halde başarı nedeni anlaşılamaz."
    }
  ]
};

const List<Map<String, dynamic>> sosyalMedyaNotes = [
  sosyalMedyaUnit1,
  sosyalMedyaUnit2,
  sosyalMedyaUnit3,
];
